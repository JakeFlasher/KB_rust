---
Use when: framing realized-vs-expected alpha as risk-budget consumption with the tracking-error allocation framework rather than as a manager-skill signal
Primary raw source: CFA_Program_Curriculum/CFA_2022_Level_I_Volumes_1-6.pdf Vol.5/pp.551-572
Supporting sources:
  - CFA_Program_Curriculum/CFA_2022_Level_I_Volumes_1-6.pdf Vol.5/pp.551-572
Repo touchpoints:
  - ../09_portfolio_management_and_asset_pricing/pm-active-management-and-alpha.md
  - ../09_portfolio_management_and_asset_pricing/pm-tracking-error-and-active-risk.md
  - rm-risk-objectives-and-tolerance.md
Out of scope: manager-skill evaluation and alpha-decay framing (09 territory under the Pedersen extension); performance-attribution worked drills (future-15 territory)
CFA Relevance: core
LOS: 11-VALUE_ADDED_ACTIVE_RETURN_LOS
