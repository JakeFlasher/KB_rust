---
Use when: deriving the Monte Carlo VaR estimator from a factor-model + path-simulation framework and noting the multi-period scaling intuition
Primary raw source: 11_Risk_Management/McNeil_Frey_Embrechts_Quantitative_Risk_Management.pdf pp.346-347
Supporting sources:
  - 11_Risk_Management/McNeil_Frey_Embrechts_Quantitative_Risk_Management.pdf pp.347-349
Repo touchpoints:
  - ../07_derivatives_and_volatility/deriv-monte-carlo-pricing.md
  - rm-var-and-es-taxonomy.md
  - rm-value-at-risk-notes.md
  - rm-parametric-var.md
  - rm-historical-simulation-var.md
Out of scope: instrument-pricing Monte Carlo (07 territory: option pricing, exotic derivatives); convergence-rate numerical examples
