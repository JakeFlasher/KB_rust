---
Use when: deriving the historical-simulation VaR estimator from an empirical loss-quantile and noting the dynamic-historical-simulation volatility-scaling extension
Primary raw source: 11_Risk_Management/McNeil_Frey_Embrechts_Quantitative_Risk_Management.pdf pp.342-345
Supporting sources:
  - none
Repo touchpoints:
...
Out of scope: filtered historical simulation full machinery (defers to future-01); empirical-quantile bias corrections
