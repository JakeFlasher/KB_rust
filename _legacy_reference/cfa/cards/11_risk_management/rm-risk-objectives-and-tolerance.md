---
Use when: framing the L1 risk-objective + risk-tolerance + ability-vs-willingness structure as a risk-management input rather than a portfolio-construction input
Primary raw source: CFA_Program_Curriculum/CFA_2022_Level_I_Volumes_1-6.pdf Vol.6/pp.5-25
Supporting sources:
  - 11_Risk_Management/McNeil_Frey_Embrechts_Quantitative_Risk_Management.pdf pp.30-34
Repo touchpoints:
  - ../09_portfolio_management_and_asset_pricing/pm-risk-tolerance-and-objectives.md
  - .claude/knowledge/11_risk_management/rm-loss-distribution-anatomy.md
  - .claude/knowledge/11_risk_management/rm-value-added-active-return.md
Out of scope: portfolio-construction allocation mechanics (09 territory); IPS implementation depth (09 territory plus future wealth-management plans)
CFA Relevance: core
