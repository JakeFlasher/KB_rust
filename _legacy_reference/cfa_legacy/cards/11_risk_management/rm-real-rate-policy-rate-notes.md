---
Use when: decomposing real-rate and policy-rate movements as inputs into the loss-distribution discount-rate channel without re-deriving the macroeconomic identity
Primary raw source: CFA_Program_Curriculum/CFA_2022_Level_I_Volumes_1-6.pdf Vol.2/pp.278-310
Supporting sources:
  - CFA_Program_Curriculum/CFA_2022_Level_I_Volumes_1-6.pdf Vol.2/pp.278-310
Repo touchpoints:
  - ../02_economics/ec-monetary-policy-and-inflation.md
  - ../02_economics/ec-monetary-fiscal-policy-mechanics-l1.md
  - rm-loss-distribution-anatomy.md
Out of scope: macroeconomic monetary-policy derivation (02 territory: Taylor rule, Mundell-Fleming, real-rate vs policy-rate equation derivation); central-bank reaction-function depth
CFA Relevance: core
LOS: 11-REAL_RATE_POLICY_RATE_NOTES_LOS
