# Retracted scenario 04

After `kb retract input/retracted-card-04.md`, the expected outputs are:
...
- A subsequent `kb verify input/retracted-card-04.md` exits 1 with primary code
