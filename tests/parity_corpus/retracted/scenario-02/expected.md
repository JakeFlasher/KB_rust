# Retracted scenario 02

After `kb retract input/retracted-card-02.md`, the expected outputs are:
...
- A subsequent `kb verify input/retracted-card-02.md` exits 1 with primary code
