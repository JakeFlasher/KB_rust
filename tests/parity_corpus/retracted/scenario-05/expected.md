# Retracted scenario 05

After `kb retract input/retracted-card-05.md`, the expected outputs are:
...
- A subsequent `kb verify input/retracted-card-05.md` exits 1 with primary code
