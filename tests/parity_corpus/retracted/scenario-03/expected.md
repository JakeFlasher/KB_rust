# Retracted scenario 03

After `kb retract input/retracted-card-03.md`, the expected outputs are:
...
- A subsequent `kb verify input/retracted-card-03.md` exits 1 with primary code
