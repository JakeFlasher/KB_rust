...
- [`mt-roll-implicit-spread-estimator`](../14_microstructure_and_trading/mt-roll-implicit-spread-estimator.md), [`mt-kyle-lambda-market-depth-price-impact`](../14_microstructure_and_trading/mt-kyle-lambda-market-depth-price-impact.md), and [`mt-price-impact-measures-amihud`](../14_microstructure_and_trading/mt-price-impact-measures-amihud.md) (reading 14) give the primary-source derivations of the Roll, Kyle, and Amihud estimators; this card collects them through the fund-arbitrage lens and adds Madhavan's crowding/capacity point.
