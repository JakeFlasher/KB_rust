...
- [`mt-funding-liquidity-fire-sales`](../14_microstructure_and_trading/mt-funding-liquidity-fire-sales.md) (reading 14) derives the performance-sensitive-capital limits-to-arbitrage mechanism from primary sources; this card applies it to the fund creation/redemption break.
