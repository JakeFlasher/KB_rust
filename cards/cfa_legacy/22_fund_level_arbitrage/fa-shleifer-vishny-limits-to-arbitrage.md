...
- [`mt-funding-liquidity-fire-sales`](../14_microstructure_and_trading/mt-funding-liquidity-fire-sales.md) and [`mt-value-traders-arbitrageurs`](../14_microstructure_and_trading/mt-value-traders-arbitrageurs.md) (reading 14) derive the same performance-sensitive-capital limits-to-arbitrage mechanism from primary sources; this card applies it to the fund creation/redemption break.
