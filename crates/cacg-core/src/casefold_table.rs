// @generated by legacy_python_oracle/scripts/build_casefold_table.py -- DO NOT EDIT BY HAND.
//
// Unicode full case-folding map, derived directly from CPython
// `str.casefold()`. Reproduces `cacg.normalize.normalize_for_lookup`'s
// `.casefold()` step byte-for-byte. Entries whose casefold is the identity
// are omitted; lookups fall through to the input scalar unchanged.
//
// Sorted by key (the input scalar) for binary search. Regenerate with
// `legacy_python_oracle/.venv/bin/python legacy_python_oracle/scripts/build_casefold_table.py`.
//
// Entry count: 1557
#[rustfmt::skip]
#[allow(clippy::unreadable_literal)]
static CASE_FOLD: &[(char, &str)] = &[
    ('\u{41}', "\u{61}"),
    ('\u{42}', "\u{62}"),
    ('\u{43}', "\u{63}"),
    ('\u{44}', "\u{64}"),
