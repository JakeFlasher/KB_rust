...
CARDS_DIR = ROOT / "cards/cfa/10_behavioral_finance"
OUT = ROOT / "out/cfa"
...
PAGE_COORDINATE_MAP = {
    "schema_version": "cfa.page_coordinate_map.v1",
...
def build_citation_plan(resolved: dict[str, list[dict[str, Any]]]) -> dict[str, Any]:
    return {
        "schema_version": "cfa.behavioral_finance_first_slice_citation_plan.v1",
        "reading_id": "10_behavioral_finance",
        "card_ids": CARD_IDS,
