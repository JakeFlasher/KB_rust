...
CARDS_DIR = ROOT / "cards/cfa/05_equity"
LEGACY_REF_DIR = ROOT / "_legacy_reference/cfa/cards/05_equity"
OUT = ROOT / "out/cfa"
...
def main() -> int:
    ...
    write_atomic(
        ...
        json.dumps({"schema_version": "cfa.eq_05_slice.v1", "cards": plan}, indent=2, sort_keys=True, ensure_ascii=False) + "\n",
    )
