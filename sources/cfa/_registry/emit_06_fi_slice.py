...
CARDS_DIR = ROOT / "cards/cfa/06_fixed_income_and_credit"
LEGACY_REF_DIR = ROOT / "_legacy_reference/cfa/cards/06_fixed_income_and_credit"
OUT = ROOT / "out/cfa"
...
def main() -> int:
    ...
    if not args.plan_only:
        write_atomic(
            ...
            json.dumps({"schema_version": "cfa.fi_06_slice.v1", "cards": plan}, indent=2, sort_keys=True, ensure_ascii=False) + "\n",
        )
