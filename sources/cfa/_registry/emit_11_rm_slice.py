...
Pipeline per card:
  ...
  5. Render and atomic-write to cards/cfa/11_risk_management/.
...
CARDS_DIR = ROOT / "cards/cfa/11_risk_management"
LEGACY_REF_DIR = ROOT / "_legacy_reference/cfa/cards/11_risk_management"
OUT = ROOT / "out/cfa"
...
def main() -> int:
    ...
    write_atomic(
        ...
        json.dumps({"schema_version": "cfa.rm_11_slice.v1", "cards": plan}, indent=2, sort_keys=True, ensure_ascii=False) + "\n",
    )
