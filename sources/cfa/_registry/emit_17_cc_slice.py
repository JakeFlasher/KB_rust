...
CARDS_DIR = ROOT / "cards/cfa/17_cross_cutting"
LEGACY_REF_DIR = ROOT / "_legacy_reference/cfa/cards/17_cross_cutting"
OUT = ROOT / "out/cfa"
...
def main() -> int:
    ...
    write_atomic(
        ...
        json.dumps({"schema_version": "cfa.cc_17_slice.v1", "cards": plan}, indent=2, sort_keys=True, ensure_ascii=False) + "\n",
    )
