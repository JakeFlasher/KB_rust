...
CARDS_DIR = ROOT / "cards/cfa/08_convertible_bonds"
LEGACY_REF_DIR = ROOT / "_legacy_reference/cfa/cards/08_convertible_bonds"
OUT = ROOT / "out/cfa"
...
def main() -> int:
    ...
    if not args.plan_only:
        write_atomic(
            ...
            json.dumps({"schema_version": "cfa.cb_08_slice.v1", "cards": plan}, indent=2, sort_keys=True, ensure_ascii=False) + "\n",
        )
