...
CARDS_DIR = ROOT / "cards/cfa/01_quantitative_methods"
LEGACY_REF_DIR = ROOT / "_legacy_reference/cfa/cards/01_quantitative_methods"
OUT = ROOT / "out/cfa"
...
def main() -> int:
    ...
    write_atomic(
        ...
        json.dumps({"schema_version": "cfa.qm_01_slice.v1", "cards": plan}, indent=2, sort_keys=True, ensure_ascii=False) + "\n",
    )
