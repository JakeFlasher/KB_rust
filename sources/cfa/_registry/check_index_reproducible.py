...
All work happens under the gitignored `out/cfa/_repro/`; the REAL corpus is never
...
`sources/cfa/_registry/release_baseline/index_repro.json` (frozen hashes + the epoch
...
CARDS = REPO / "cards/cfa"
STAGE = REPO / "out/cfa/_repro"
PROOF = REPO / "sources/cfa/_registry/release_baseline/index_repro.json"
...
def main() -> int:
    ...
    proof = {
        "schema_version": "cfa_index_repro/v2",
