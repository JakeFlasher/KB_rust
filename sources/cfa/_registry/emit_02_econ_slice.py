...
CARDS_DIR = ROOT / "cards/cfa/02_economics"
LEGACY_REF_DIR = ROOT / "_legacy_reference/cfa/cards/02_economics"
OUT = ROOT / "out/cfa"
...
def main() -> int:
    ...
    if not args.plan_only:
        write_atomic(
            ...
            json.dumps({"schema_version": "cfa.ec_02_slice.v1", "cards": plan}, indent=2, sort_keys=True, ensure_ascii=False) + "\n",
        )
