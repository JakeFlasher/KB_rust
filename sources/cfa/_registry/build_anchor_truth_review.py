...
CHUNKS_MANIFEST = REPO / "out/cfa/chunks_manifest.json"
SOURCE_MATRIX = REPO / "out/cfa/source_matrix.json"
CARDS_ROOT = REPO / "cards/cfa"
...
def main() -> int:
    ...
    artifact = {
        "schema_version": "cfa_anchor_truth_review/v2",
