...
CARDS_DIR = ROOT / "cards/cfa/03_financial_reporting_analysis"
LEGACY_REF_DIR = ROOT / "_legacy_reference/cfa/cards/03_financial_reporting_analysis"
OUT = ROOT / "out/cfa"
...
def main() -> int:
    ...
    if not args.plan_only:
        write_atomic(
            ...
            json.dumps({"schema_version": "cfa.fra_03_slice.v1", "cards": plan}, indent=2, sort_keys=True, ensure_ascii=False) + "\n",
        )
