...
KB="./target/debug/kb"
CARDS_DIR="cards/cfa_legacy"
CHUNKS="out/cfa_legacy/chunks_manifest.json"
MATRIX="out/cfa_legacy/source_matrix.json"
MANIFEST="out/cfa_legacy/cards_manifest.json"
BASE="sources/cfa_legacy/_registry/release_baseline"
...
jq -n \
  ...
  --argjson fails "$fails" \
  '{schema_version:"cfa_legacy_verify_baseline/v1",
