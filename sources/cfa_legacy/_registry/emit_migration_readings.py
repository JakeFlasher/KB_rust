#!/usr/bin/env python3
"""Emit the three migrated cacg.v0 readings into ``cards/cfa_legacy/``.
...
REGISTRY_SCHEMA_VERSION = "cfa_legacy.migration_curated_citations.v1"
...
QUEUE_ADDITIONS_SCHEMA = "cfa_legacy.migration_queue_additions.v1"
...
def queue_record(card: dict[str, Any], reading: Reading) -> dict[str, Any]:
    ...
    return {
        ...
        "title": card["title"],
        "target_path": f"cards/cfa_legacy/{reading.reading_id}/{cid}.md",
