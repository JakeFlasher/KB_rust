...
fund-level card skeletons before they are migrated into the cfa_legacy corpus.

This is a read-only proof, run BEFORE any PDF is copied or ingested, that every
incoming skeleton is structurally ready to become a real cfa_legacy card:
...
CARDS_MANIFEST = ROOT / "out/cfa_legacy/cards_manifest.json"
CARDS_DIR = ROOT / "cards/cfa_legacy"
...
def run_checks() -> dict[str, Any]:
    ...
    return {
        "schema_version": "cfa_legacy.incoming_skeleton_preflight.v1",
