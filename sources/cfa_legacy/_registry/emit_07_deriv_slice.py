...
CARDS_DIR = ROOT / "cards/cfa_legacy/07_derivatives_and_volatility"
LEGACY_REF_DIR = ROOT / "_legacy_reference/cfa_legacy/cards/07_derivatives_and_volatility"
...
def main() -> int:
    ...
    write_atomic(
        ...
        json.dumps({"schema_version": "cfa_legacy.deriv_07_slice.v1", "cards": plan}, indent=2, sort_keys=True, ensure_ascii=False) + "\n",
    )
