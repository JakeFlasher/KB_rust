...
EXCLUDED = ROOT / "sources/cfa_legacy/excluded"
...
def build_input_fingerprints(
    ...
    return {
        "schema_version": "cfa_legacy.preflight_input_fingerprints.v1",
        "files": {
...
def build_queue() -> dict[str, Any]:
        ...
        cards.append(
            {
                ...
                "target_path": f"cards/cfa_legacy/{reading_id}/{card_id}.md",
                "title": title,
    ...
    queue = {
        "schema_version": "cfa_legacy.card_migration_preflight.v1",
        "generated_at_utc": generated_at,
    ...
    ref_map = {
        "schema_version": "cfa_legacy.legacy_source_ref_map.v1",
        "generated_at_utc": generated_at,
        "artifact_set_id": set_id,
        "input_fingerprints": input_fingerprints,
        "summary": {
...
def build_page_offset_worklist(queue: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "schema_version": "cfa_legacy.page_offset_worklist.v1",
